...
const mockNotifications = [
  { id: 1, title: "New student registration", message: "John Doe wants to enroll", time: "2m ago" },
  { id: 2, title: "Task submitted", message: "Emily completed Math Assignment", time: "1h ago" },
  { id: 3, title: "Payment received", message: "$150 from Sarah for Piano class", time: "3h ago" },
];
